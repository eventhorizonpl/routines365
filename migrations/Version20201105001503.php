 ...
 */
final class Version20201105001503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE kpi ADD completed_routine_counter INT NOT NULL, ADD contact_counter INT NOT NULL, ADD project_counter INT NOT NULL, ADD reward_counter INT NOT NULL, ADD saved_email_counter INT NOT NULL');
        $this->addSql('ALTER TABLE user ADD last_login_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetimetz_immutable)\'');
    }
