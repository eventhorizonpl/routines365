 ...
 */
final class Version20210114142153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_kyt (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, basic_configuration_learned TINYINT(1) NOT NULL, basic_configuration_sent TINYINT(1) NOT NULL, completing_routines_learned TINYINT(1) NOT NULL, completing_routines_sent TINYINT(1) NOT NULL, date_of_last_message DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', goals_learned TINYINT(1) NOT NULL, goals_sent TINYINT(1) NOT NULL, notes_learned TINYINT(1) NOT NULL, notes_sent TINYINT(1) NOT NULL, projects_learned TINYINT(1) NOT NULL, projects_sent TINYINT(1) NOT NULL, reminders_learned TINYINT(1) NOT NULL, reminders_sent TINYINT(1) NOT NULL, rewards_learned TINYINT(1) NOT NULL, rewards_sent TINYINT(1) NOT NULL, routines_learned TINYINT(1) NOT NULL, routines_sent TINYINT(1) NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_by CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', deleted_by CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', updated_by CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', UNIQUE INDEX UNIQ_F940EBC2D17F50A6 (uuid), UNIQUE INDEX UNIQ_F940EBC2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
